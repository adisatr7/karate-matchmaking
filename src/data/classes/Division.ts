...
export class Division {
   ...
   */
  constructor(divisionId?: string, tournamentId: string = "", divisionName: string = "", registeredTeams: ContestantType[] = [], matchIds: string[] = []) {
    this.divisionId = divisionId || generateID()
  ...
  public removeRegisteredTeam(team: ContestantType): void {
    this.registeredTeams = this.registeredTeams.filter((registeredTeam) => registeredTeam.teamId !== team.teamId)
  }
